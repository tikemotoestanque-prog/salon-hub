...
export default function SalesLedger() {
  ...
  // VIPランキングは期間フィルタに関わらず、全顧客の累計で判定する
  const rankedCustomers = useMemo(() => {
    const list = [...customers]
    if (rankBy === 'spent') return list.sort((a, b) => (b.totalSpent || 0) - (a.totalSpent || 0)).slice(0, 10)
      ...
      <div className="dash-grid">
        ...
        <div>
          ...
          <div className="card section">
            ...
            <p style={{ margin: '0 0 10px', fontSize: 12, color: 'var(--muted)' }}>常連さんへの特別対応の目印に。期間フィルタに関わらず、全期間の累計で並びます。</p>
            ...
            {rankedCustomers.length === 0 ? (
              ...
              <div className="target-row" key={c.id} onClick={() => nav('/customer/' + c.id)}>
                <div>
                  ...
                  <div className="tsub">来店 {c.visitCount || 0}回 / 累計 {yen(c.totalSpent || 0)}</div>
                </div>
